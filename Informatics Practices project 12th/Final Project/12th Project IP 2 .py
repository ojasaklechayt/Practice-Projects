    ...
    def update():
        ...
        while (c1=='y' or c1=='Y'):
            ...
            if c==0:
                ...
                if f>=75 and f<80:
                    cur=con.cursor()
                    cur.execute("update college_admission set name='%s',dob='%s',gender='%s',year_of_admission=%s,12th_Board_percentage=%s where name='%s'"%(d,e,h,g,f,'Electronics'))
                    con.commit()
                    print("Record updated successfully...")
                elif f>=80 and f<85 :
                    ...
                    if ao=='Electronics' or ao=='electronics':
                        cur=con.cursor()
                        cur.execute("update college_admission set name='%s',dob='%s',gender='%s',year_of_admission=%s,12th_Board_percentage=%s where name='%s'"%(d,e,h,g,f,'Mechanics'))
                        con.commit()
                        print("Record updated successfully...")
                    ...
                    if ao=='electronics' or ao=='Electronics':
                        ...
                        cur=con.cursor()
                        cur.execute("update college_admission set name='%s',dob='%s',gender='%s',year_of_admission=%s,12th_Board_percentage=%s where name='%s'"%(d,e,h,g,f,jai))
                        con.commit()
                        print("Record updated successfully...")
    ...
    if ch==2:
        ...
        while (z=='y' or z=='Y'):
            ...
            if c1==2:
                ...
                print('*'*60)
            z='y' or 'Y'
        c=input("Want to log out ? : press y for yes and press n for no : ")
    if ch>=3:
        print("wrong choice entered!!!")
        print('*'*60)
else:
